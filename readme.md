...
You can maintain your extension at the [command line](https://github.com/annaesvensson/yellow-core). Make sure to complete the [review checklist](https://github.com/annaesvensson/yellow-help/blob/main/yellow-review-checklist.md). Are you ready to maintain your extension? Open a terminal window. Go to your installation folder, where the file `yellow.php` is. Type `php yellow.php maintain all`. You can optionally add the name of a folder. This will update the necessary files. Upload your changes and create a pull request for the repository `datenstrom/yellow`.
